import { ImgConversionUtils } from '@label-u/utils';
...
import {IScribbleConfig ,IScribbleData} from '../../types/tool/scribbleTool'
...
class ScribbleTool extends BasicToolOperation {
  ...
  public render() {
    ...
    DrawUtils.drawImg(this.canvas, this.cacheCanvas as unknown as  HTMLImageElement, {
      zoom: this.zoom,
