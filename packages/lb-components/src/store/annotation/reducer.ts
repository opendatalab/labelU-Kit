...
import { AnnotationEngine, CommonToolUtils, ImgUtils, cTool } from '@label-u/lb-annotation';
import { EToolName } from '@label-u/lb-annotation/es/types/constant/tool';
import { i18n } from '@label-u/lb-utils';
...
const updateToolInstance = (annotation: AnnotationState, imgNode: HTMLImageElement) => {
  ...
  } // 在工具中统一用json对象，在lb-web层统一处理string 和 json转换
