...
import { ReactComponent as TreeSwitcherIcon } from '@/assets/tree-switcher.svg';
              ...
              title: (
                <div className="category">
                  ...
                  <Form.Item name={[...path, index, 'key']} rules={[{ required: true, message: '请填写完整' }]}>
                    <Input placeholder={`Label`} onChange={handleOnChange(`[${index}].key`)} />
                  </Form.Item>
                  <Form.Item
                  ...
                  >
                    <Input placeholder={`Value`} onChange={handleOnChange(`[${index}].value`)} />
                  </Form.Item>
                  <FlexLayout>
                    <Tooltip title="是否必填">
          ...
          return {
            title: (
              <div className="option">
                ...
                >
                  <Input placeholder={`Label`} onChange={handleOnChange(`[${preIndex}]options[${index}].key`)} />
                </Form.Item>
                <Form.Item
                  name={[...path, index, 'value']}
                  // @ts-ignore
                  rules={[{ required: true, message: '请填写完整' }, duplicatedValueValidator(path, index)]}
                >
                  <Input placeholder={`Value`} onChange={handleOnChange(`[${preIndex}]options[${index}].value`)} />
                </Form.Item>
                <StyledStar
